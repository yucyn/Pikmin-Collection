  ...
  function ensureEditModal() {
    ...
    modal.innerHTML = `
      ...
      <form id="editForm" class="edit-modal-panel">
        ...
        <label for="editAuthorInput">作者</label>
        <input id="editAuthorInput" type="text" placeholder="作者" />

        <label for="editSourceInput">資料來源</label>
        <input id="editSourceInput" type="text" placeholder="資料來源" />
