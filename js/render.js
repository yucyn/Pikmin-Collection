...
function renderPostcards({
  ...
  list.forEach(item => {
    ...
    const isAuthUnlocked = Boolean(
      ...
      typeof window.PikminAuthGate.isUnlocked === "function" &&
      window.PikminAuthGate.isUnlocked()
    );
    ...
    if (typeof onEditClick === "function" && !isBrowseMode && isAuthUnlocked) {
    ...
    if (!isBrowseMode && isAuthUnlocked) {
