  ...
  function initAdminLogic() {
    ...
    try {
      ...
      function enableAdminFeatures() {
        ...
        // 真正的管理員可以編輯網站標題與公告
        document.querySelectorAll("#siteTitle, #siteSubtitle, #bulletinContent").forEach(el => {
      ...
      if (sendMsgBtn) {
        sendMsgBtn.addEventListener("click", () => {
          ...
          guestbookColl.add({
            ...
            sendMsgBtn.innerText = originalText;
          });
        });
      }
      ...
      window.saveTitleUpdate = async (id, val) => {
        try {
          ...
          if (isAdmin) alert("自動儲存失敗：" + e.message);
        }
      };
