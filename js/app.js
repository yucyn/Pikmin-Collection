...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function bindTagFilterButtons() {
    ...
    // 把 mobileTagMenu 移進 body 並用 position:fixed 定位，確保不受頁面捲動影響
    const tagMenuHost = document.body;
    ...
    const placeMobileTagMenuNearButton = () => {
      ...
      mobileTagMenu.style.position = "fixed";
